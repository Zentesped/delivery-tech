...
private void inserirRestaurantes() {
    ...
    restaurante6.setNome("Sorveteria da Maria");
    restaurante6.setCategoria("Sorvetes");
    restaurante6.setTelefone("1432361014");
    restaurante6.setTaxaEntrega(new BigDecimal("7.00"));
    restaurante6.setAtivo(true);

    restauranteRepository.saveAll(Arrays.asList(restaurante1, restaurante2, restaurante3, restaurante4, restaurante5, restaurante6));
    System.out.println("✓ 6 restaurantes inseridos");
